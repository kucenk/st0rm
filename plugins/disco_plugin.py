...
register_command_handler(handler_disco, 'disco', ['muc','info','all'], 10, 'Shows results of the review services for the specified JID.\nIt is also possible to browse on point (node). Request Format jid#node.\nSecond or third (if the limiter is also given number of) option - search. Looking for a given word in JID and description of disco. If the search word to specify the name of the conference to the server name (example qwerty@), it will display the location of the conference in the overall rankings.\nIn general chat can give max 50 results, without specifying count - 10.\nIn privat will give max 250, without specifying count 50.', 'disco <server> <number of results> <search string>', ['disco server.tld','disco conference.server.tld 5','disco conference.server.tld qwerty','disco conference.jabber.aq 5 qwerty','disco conference.server.tld qwerty@', 'disco server.tld#services'])
